...
export default function ExperienceCard ({experience, index} : ExperienceCardProps) {
    return (
        ...
        >
            {/* Timeline line */}
            <div className="absolute left-[11px] top-1 bottom-0 w-px bg-gradient-to-b from-blue-100 to-blue-600" />

            {/* Timeline dot */}
            <div className="absolute left-0 top-1 w-[23px] h-[23px] rounded-full bg-gradient-to-br bg-blue-500 to-blue-600 flex items-center justify-center">
