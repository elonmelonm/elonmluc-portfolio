...
const HeroLeft = () => {
  ...
  return (
    ...
    style={{ opacity: opacity }}
        ...
        className="fixed right-8 xl:right-12 my-16 h-auto py-5 p-4 rounded-2xl bg-slate-100 dark:bg-slate-800 backdrop-blur-sm z-50 shadow-sm hidden lg:block"
    >
        <motion.h1 
        ...
        <motion.p 
            variants={itemVariants}
            className="w-64 text-lg text-gray-600 dark:text-gray-300 mb-8 transition-colors duration-300"
        >
        ...
        >
            <motion.a 
                href="#projets"
                className="inline-flex items-center px-2 text-sm py-3 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-300"
    ...
    <div className="flex-1 lg:hidden">
        ...
        <motion.span 
            className="text-blue-600 text-xl lg:text-2xl dark:text-blue-400 inline-block mb-4"
            >
