        ...
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    ...
                    >
                        I'm a creative developer based in Benin, and I'm very passionate and dedicated to my work.
                    </motion.p>
                    ...
                    <motion.div 
                        className="mt-4 justify-center p-2 rounded-full hidden md:flex items-center space-x-8"
                        variants={itemVariants}
                        initial="hidden"
                        animate="visible"
                    >
